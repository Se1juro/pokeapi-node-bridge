...
let PokemonController = class PokemonController {
    ...
    getAllPokemon(limit, page) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.pokemonService.getAllPokemon(limit, page);
        });
    }
    getPokemonByName(name, page) {
...
__decorate([
    ...
    __param(0, (0, routing_controllers_1.QueryParam)("name")),
    __param(1, (0, routing_controllers_1.QueryParam)("page")),
    __metadata("design:type", Function),
...
PokemonController = __decorate([
    (0, routing_controllers_1.JsonController)("/api/pokemon"),
    (0, routing_controllers_1.UseBefore)(auth_middleware_1.AuthJwtMiddleare),
